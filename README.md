...
*From Lovable and Gemini Pro with Love* ❤️
...
Dự án đã được deploy và lưu trữ trực tuyến thông qua **Cloudflare Pages**, cho phép bạn trải nghiệm ngay mà không cần cài đặt môi trường:

* 👉 **Front-office (Khách hàng):** https://melodise-frontoffice.camtran3506.workers.dev/
* 👉 **Back-office (Quản trị):** https://melodise-backoffice.camtran3506.workers.dev/ 
...
npm run dev
```
👉 Truy cập giao diện khách hàng tại: `http://localhost:8080` (hoặc port tương ứng hiển thị trên terminal).
